export const fr = {
  ...
  "safe_space_desc": "Un espace sûr et bienveillant pour te connecter à ton corps à travers la danse consciente et t'exprimer librement. La connexion non-verbale avec les autres est également très bienvenue",

  "diverse_soundscape": "Paysage Sonore Diversifié",
  "diverse_soundscape_desc": "Un paysage sonore vivant et diversifié",
  "see_musical_journey": "voir Voyage Musical",
  ...
  "dj_intro_2": "Avec des années d'expérience dans la création de paysages sonores transformateurs (ecstatic dance et autres), je vous guide à travers un voyage musical soigneusement conçu qui invite à l'expression authentique et à la connexion profonde.",
  ...
  "creating_spaces": "Créer des espaces sûrs pour la danse libre authentique depuis 2019",
